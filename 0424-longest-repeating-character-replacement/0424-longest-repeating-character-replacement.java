...
Space: O(1): Similar to the previous approaches, this approach requires an auxiliary frequency map. The maximum number of keys in the map equals the number of unique characters in the string. If there are mmm unique characters, then the memory required is proportional to mmm. So the space complexity is O(m). Considering uppercase English letters only, m=26.
*/
